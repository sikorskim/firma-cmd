...
namespace firma_mvc.Controllers
{
    public class PaymentMethodsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DueTerm")] PaymentMethod paymentMethod)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DueTerm")] PaymentMethod paymentMethod)
        {
